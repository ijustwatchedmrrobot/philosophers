...
n_samples = 1000000  # Number of samples for randomness tests
...
for method_name, method in methods_for_tests.items():
    numbers = method(n_samples)
    with open(f'{method_name}_numbers.txt', 'w') as f:
        for number in numbers:
            f.write(f'{number}\n')

print("Random numbers generated and saved to files for Diehard tests.")
